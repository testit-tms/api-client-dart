...
**entityTypes** | [**Set<WorkItemTypeModel>**](WorkItemTypeModel.md) | Collection of types of work item    Allowed values: `TestCases`, `CheckLists`, `SharedSteps` | [optional] [default to const {}]
