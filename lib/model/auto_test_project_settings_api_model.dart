...
class AutoTestProjectSettingsApiModel {
  /// Returns a new [AutoTestProjectSettingsApiModel] instance.
  ...
  /// Returns a new [AutoTestProjectSettingsApiModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AutoTestProjectSettingsApiModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AutoTestProjectSettingsApiModel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AutoTestProjectSettingsApiModel[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AutoTestProjectSettingsApiModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AutoTestProjectSettingsApiModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AutoTestProjectSettingsApiModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AutoTestProjectSettingsApiModel> mapFromJson(dynamic json) {
    final map = <String, AutoTestProjectSettingsApiModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AutoTestProjectSettingsApiModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AutoTestProjectSettingsApiModel-objects as value to a dart map
  static Map<String, List<AutoTestProjectSettingsApiModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AutoTestProjectSettingsApiModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AutoTestProjectSettingsApiModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
