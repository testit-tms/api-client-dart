...
class TestPlanModel {
  /// Returns a new [TestPlanModel] instance.
  TestPlanModel({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TestPlanModel &&
    other.status == status &&
  ...
  static TestPlanModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TestPlanModel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TestPlanModel[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TestPlanModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TestPlanModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TestPlanModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TestPlanModel> mapFromJson(dynamic json) {
    final map = <String, TestPlanModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TestPlanModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TestPlanModel-objects as value to a dart map
  static Map<String, List<TestPlanModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TestPlanModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TestPlanModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
