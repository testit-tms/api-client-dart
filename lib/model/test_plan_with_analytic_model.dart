...
class TestPlanWithAnalyticModel {
  /// Returns a new [TestPlanWithAnalyticModel] instance.
  ...
  TestPointAnalyticResult analytic;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TestPlanWithAnalyticModel &&
  ...
  /// Returns a new [TestPlanWithAnalyticModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TestPlanWithAnalyticModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TestPlanWithAnalyticModel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TestPlanWithAnalyticModel[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TestPlanWithAnalyticModel(
        analytic: TestPointAnalyticResult.fromJson(json[r'analytic'])!,
  ...
  static List<TestPlanWithAnalyticModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TestPlanWithAnalyticModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TestPlanWithAnalyticModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TestPlanWithAnalyticModel> mapFromJson(dynamic json) {
    final map = <String, TestPlanWithAnalyticModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TestPlanWithAnalyticModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TestPlanWithAnalyticModel-objects as value to a dart map
  static Map<String, List<TestPlanWithAnalyticModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TestPlanWithAnalyticModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TestPlanWithAnalyticModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
