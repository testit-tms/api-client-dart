...
class TestPointFilterModel {
  /// Returns a new [TestPointFilterModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TestPointFilterModel &&
  ...
  /// Returns a new [TestPointFilterModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TestPointFilterModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TestPointFilterModel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TestPointFilterModel[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TestPointFilterModel(
  ...
  static List<TestPointFilterModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TestPointFilterModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TestPointFilterModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TestPointFilterModel> mapFromJson(dynamic json) {
    final map = <String, TestPointFilterModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TestPointFilterModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TestPointFilterModel-objects as value to a dart map
  static Map<String, List<TestPointFilterModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TestPointFilterModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TestPointFilterModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
