...
class TestRunStatisticsFilterApiModel {
  /// Returns a new [TestRunStatisticsFilterApiModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TestRunStatisticsFilterApiModel &&
  ...
  @override
  String toString() => 'TestRunStatisticsFilterApiModel[configurationIds=$configurationIds, outcomes=$outcomes, statusCodes=$statusCodes, failureCategories=$failureCategories, namespace=$namespace, className=$className]';
  ...
  /// Returns a new [TestRunStatisticsFilterApiModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TestRunStatisticsFilterApiModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TestRunStatisticsFilterApiModel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TestRunStatisticsFilterApiModel[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TestRunStatisticsFilterApiModel(
  ...
  static List<TestRunStatisticsFilterApiModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TestRunStatisticsFilterApiModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TestRunStatisticsFilterApiModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TestRunStatisticsFilterApiModel> mapFromJson(dynamic json) {
    final map = <String, TestRunStatisticsFilterApiModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TestRunStatisticsFilterApiModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TestRunStatisticsFilterApiModel-objects as value to a dart map
  static Map<String, List<TestRunStatisticsFilterApiModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TestRunStatisticsFilterApiModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TestRunStatisticsFilterApiModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
