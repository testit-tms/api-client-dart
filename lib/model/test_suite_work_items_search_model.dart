...
class TestSuiteWorkItemsSearchModel {
  /// Returns a new [TestSuiteWorkItemsSearchModel] instance.
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.nameOrId != null) {
      json[r'nameOrId'] = this.nameOrId;
    } else {
      json[r'nameOrId'] = null;
    }
    if (this.includeIds != null) {
      json[r'includeIds'] = this.includeIds!.toList(growable: false);
    } else {
      json[r'includeIds'] = null;
    }
  ...
  /// Returns a new [TestSuiteWorkItemsSearchModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TestSuiteWorkItemsSearchModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TestSuiteWorkItemsSearchModel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TestSuiteWorkItemsSearchModel[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TestSuiteWorkItemsSearchModel(
  ...
  static List<TestSuiteWorkItemsSearchModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TestSuiteWorkItemsSearchModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TestSuiteWorkItemsSearchModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TestSuiteWorkItemsSearchModel> mapFromJson(dynamic json) {
    final map = <String, TestSuiteWorkItemsSearchModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TestSuiteWorkItemsSearchModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TestSuiteWorkItemsSearchModel-objects as value to a dart map
  static Map<String, List<TestSuiteWorkItemsSearchModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TestSuiteWorkItemsSearchModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TestSuiteWorkItemsSearchModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
