...
class WorkItemFilterModel {
  /// Returns a new [WorkItemFilterModel] instance.
  WorkItemFilterModel({
    this.nameOrId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is WorkItemFilterModel &&
  ...
  /// Returns a new [WorkItemFilterModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static WorkItemFilterModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "WorkItemFilterModel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "WorkItemFilterModel[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return WorkItemFilterModel(
  ...
  static List<WorkItemFilterModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <WorkItemFilterModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WorkItemFilterModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WorkItemFilterModel> mapFromJson(dynamic json) {
    final map = <String, WorkItemFilterModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WorkItemFilterModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of WorkItemFilterModel-objects as value to a dart map
  static Map<String, List<WorkItemFilterModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WorkItemFilterModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = WorkItemFilterModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
